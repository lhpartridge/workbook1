            ...
            <main className="main" id="l1l1-main">
                ...
                <section className="l1-section">
                    <div className="container">
                        <div className="row l1-a1 mb-3 lesson-row">
                            <Level1SideNav />
                            <div className="col-md-11">
                                ...
                                <Level1L1IFrame />
                            <h3 className="sub3 mt-3">Google Translate is a useful tool for practicing pronunciation.  You have to be careful with the translations, but the app is constantly improving.   <a href="https://translate.google.com/">https://translate.google.com/</a></h3>
                            ...
                            <h3 className="sub3 l1-a2sub3">Here are some more expressions to help you communicate in class. Number them and write their translations. Be sure to pronounce each one several times. Now you're ready to begin learning French! </h3>
